...
`docs/README.md` 仅作为**文档导航页**，不重复外层 `readme.md` 的项目介绍、能力清单和示例代码。
如需快速上手与完整能力说明，请优先阅读外层 `readme.md`。
...
- [项目 README](../readme.md) - 项目概述、能力总览、快速开始与配置示例
- [AGENTS.md](../AGENTS.md) - AI Coding 指南（完整 API 参考）
